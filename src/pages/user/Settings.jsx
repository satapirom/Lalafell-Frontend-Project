...
const Settings = () => {
    ...
    return (
        <div className=" mx-auto p-4 tablet:p-8  custom-bg rounded-lg mt-16 max-w-screen-xl ">
            <div className='flex space-x-2  mx-2 tablet:mx-0 my-4 tablet:mb-8 '>
                ...
                <h1 className="text-xl tablet:text-2xl font-bold  text-gray-800">Settings</h1>
            </div>
            <div className='custom-galssmorpuism mx-2 tablet:mx-0 tablet:p-8 rounded-lg shadow-md'>
