...
const Settings = () => {
    ...
    return (
        <div className="container mx-auto py-8 tablet:p-8 custom-bg rounded-lg mt-16 max-w-screen-xl ">
            <div className='flex space-x-2  mx-2 tablet:mx-0 mb-4 tablet:mb-8 '>
            ...
            <div className='custom-galssmorpuism mx-2 tablet:mx-0 p-8 rounded-lg shadow-md'>
