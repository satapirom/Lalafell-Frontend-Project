...
const PaymentCheckout = () => {
    ...
    return (
        <div className="flex justify-between items-center gap-4 rounded-lg custom-bg p-8 my-8">
            <div className="flex-grow">
                <div className='flex gap-2'>
                    ...
                    <h2 className="text-xl text-gray-800 mb-4">Selected Payment Method</h2>
                </div>
                <div className="custom-glassmorphism bg-white/50 p-8 rounded-lg shadow-sm">
                    <p className="text-lg text-gray-700 font-normal mb-2">{selectedPaymentMethod.type}</p>
                    {selectedPaymentMethod.details && (
                        <p className="text-sm text-gray-500">{selectedPaymentMethod.details}</p>
                    )}
                </div>
            </div>
            <Link to='/paymethod' className='flex-shrink-0 p-2 bg-primary-color rounded-full hover:bg-primary-color/80 transition'>
