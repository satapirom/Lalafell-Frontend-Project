    ...
    return (
        <div className="container mx-auto mt-20 p-8 custom-bg rounded-lg">
            <div className='flex items-center gap-2 mb-6 w-full'>
                ...
                <h2 className='text-xl '>Select Delivery Addresses</h2>
            </div>
                        ...
                        <div key={address._id} className="mb-4 pb-4 flex justify-between border-b">
                            <label className="flex items-center space-x-3">
                                <input
                                    ...
                                    className="form-radio h-6 w-6 focus:bg-primary-color appearance-none border border-gray-400 rounded-full cursor-pointer focus:ring-2 focus:ring-primary-color"

                                />
                                <div className="text-lg text-gray-700 space-y-2">
                                    <p className="font-normal mb-2">{address.name} | {address.phone}</p>
                                    <p className="mb-2">
                                        {address.street},&nbsp;
                                        {address.city},&nbsp;
                                        {address.country},&nbsp;
