...
const AddressManagement = () => {
    ...
    return (
        <div className="space-y-6 p-6 bg-gray-50 shadow-lg rounded-lg max-w-4xl mx-auto">
            <div className="flex justify-between items-center border-b pb-4">
                ...
                <button
                    ...
                    disabled={isLoading}
                >
                    <span className="hidden tablet:inline">Add New Address</span> {/* Text visible on medium screens and up */}
                    <FaPlus className="tablet:hidden text-lg" /> {/* Icon visible on mobile screens */}
                </button>
            </div>
